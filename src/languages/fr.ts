  ...
  "instrument": {
    ...
    "questions": {
      ...
      "Id10010": {
        ...
        "guidance": "Enregistrez ici le nom de l’intervieweur VA principal. Le bureau du projet peut ajouter une liste de noms d'intervieweurs ou recommander un format standard pour déclarer les noms (par exemple prénom, nom)."
      },
      "Id10010a": {
        "label": "(Id10010a) [Âge de l'intervieweur VA]",
        "hint": "Entrez 99 si vous ne souhaitez pas divulguer l'âge",
        "guidance": "Enregistrez ici l’âge en années de l’intervieweur principal VA. Une fois renseigné ODK Collect, la réponse au champ devient pré-remplie. Le champ n'est pas associé à l'attribution de la cause du décès ; cependant, il s’agit d’informations utiles pour voir comment fonctionne le système VA. Si les enquêteurs ne souhaitent pas répondre, inscrivez « 99 ».",
        "constraintMessage": "L'intervieweur doit être un adulte et pas plus de 89 ans"
      },
      "Id10010b": {
        "label": "(Id10010b) [Sexe de l'intervieweur VA]",
        "guidance": "Enregistrez le sexe de l’intervieweur VA principal comme étant femme, homme ou ambigu/intersexué. Une fois renseigné ODK Collect, la réponse au champ devient pré-remplie.",
        "choices": {
          "female": "Féminin",
          "male": "Masculin",
      ...
      "Id10004": {
        ...
        "guidance": "L'équipe de projet doit fournir une liste de mois classés comme humides ou secs. Sélectionnez humide ou sec selon la liste fournie. La manière dont les informations sont complétées varie selon les sites, mais idéalement, elles sont remplies par le bureau central ; les enquêteurs étant en mesure de modifier les informations si elles sont vérifiées différemment en consultation avec le bureau central.",
        "choices": {
          "wet": "HUMIDE",
          "dry": "SÈCHE",
          "DK": "Ne sait pas"
      ...
      "Id10007": {
        ...
        "guidance": "Enregistrez le nom déclaré du répondant. Déclarez les noms de façon standard comme suit : prénom (prénom), nom de famille. La question n’est pas nécessaire pour l’attribution de la cause du décès et peut être ignorée."
      },
      "Id10007a": {
      ...
      "Id10007b": {
        ...
        "guidance": "Enregistrez l’âge en années du répondant. La question n’est pas nécessaire pour l’attribution de la cause du décès et peut être ignorée.",
      ...
      "Id10008": {
        ...
        "guidance": "Vérifiez d’abord si le répondant est un membre de la famille, et seulement s’il ne s’agit pas d’un membre de la famille, choisissez parmi les autres catégories de réponses, comme « agent de santé », « agent public » ou « autre relation ». Une seule case de réponse peut être sélectionnée. Cochez la case appropriée qui représente la relation déclarée par le répondant.",
        "choices": {
          "parent": "Parent",
          "child": "Enfant",
      ...
      "Id10009": {
        "label": "(Id10009) Est-ce que vous/le répondant viviez avec la personne décédée au cours de la période précédant son décès ?",
      ...
      "Id10013": {
        ...
        "guidance": "Sélectionnez la réponse appropriée. Si le répondant n'a pas donné son consentement, clôturez l'entretien ici et enregistrez l'heure à laquelle l'entretien s'est terminé. Le consentement est demandé après Id10007-10009 comme information minimale nécessaire au contrôle de la qualité des processus d'AV.",
        "choices": {
          "yes": "Oui",
          "no": "Non"
        }
      ...
      "age_neonate_days": {
        ...
        "guidance": "Si vous avez sélectionné le questionnaire néonatal, vous devez saisir l'âge en jours. L'âge néonatal est inférieur à 28 jours, soit 0 à 27 jours révolus ; une entrée valide est comprise entre 0 et 27. Si le nouveau-né a moins de 1 jour ou 24 heures, entrez « 0 » jour.",
      ...
      "age_child_days": {
        ...
        "constraintMessage": "L'âge de l'enfant est supérieur à 28 jours ; Si la réponse était supérieure à 60 jours, demandez au répondant de déclarer le temps passé dans une autre unité."
      },
      "age_child_months": {
        "label": "[Entrez l'âge de l'enfant en mois :]",
        "constraintMessage": "Le nombre saisi est peu probable. Si la réponse était supérieure à 59 mois, demandez au répondant de déclarer le temps en années."
      },
      "age_child_years": {
      ...
      "age_adult": {
        ...
        "constraintMessage": "L'âge adulte est supérieur à 11 ans ; un âge supérieur à 120 ans est peu probable."
      },
      "ageInMonthsByYear": {
        "label": "Âge en mois"
      },
      ...
      "Id10008_check": {
        "label": "(Id10008_check) Il n'est pas possible de sélectionner que le répondant est l'enfant du défunt et de saisir que le défunt est un nouveau-né ou un enfant. Veuillez revenir en arrière et corriger la sélection."
      },
      "Id10058": {
      ...
      "Id10487": {
        "label": "(Id10487) Au cours des deux semaines précédant le décès, a-t-il vécu avec, rendu visite ou pris soin d'une personne présentant des symptômes de la COVID-19 ou un test de dépistage de la COVID-19 positif ?",
      ...
      "Id10051": {
        "label": "(Id10051) [Est-il nécessaire de collecter des données démographiques supplémentaires sur le défunt ?]",
        ...
        "guidance": "Le site du projet déterminera si ces informations doivent être collectées. Si vous choisissez « NON », vous ignorerez les détails sur le lieu de résidence, l'éducation et la famille. Si vous sélectionnez « OUI », passez à la question suivante. Les programmeurs du site peuvent cacher cette question aux enquêteurs.",
        "choices": {
          "yes": "Oui",
          "no": "Non"
        }
      ...
      "Id10053": {
        ...
        "guidance": "Enregistrez l’origine ethnique déclarée. N’insistez pas trop si la personne interrogée est mal à l’aise. Entrez « - », si cette information n'est pas disponible ou si le répondant n'est pas content de déclarer son origine ethnique."
      },
      "Id10054": {
        ...
        "guidance": "Enregistrez le lieu de naissance déclaré. Précisez ici le village et le quartier. Une question sur l'installation et les circonstances sera posée ultérieurement. Entrez un « - » si cette information n'est pas disponible ou inconnue."
      },
      "Id10055": {
        "label": "(Id10055) Quel était son lieu de résidence habituelle ? (l'endroit où la personne a vécu la majeure partie de l'année)",
        ...
        "guidance": "Pour les cas périnatals, il suffit de demander l'adresse de la formation sanitaire ou, en cas de sortie et à domicile, l'adresse du domicile. Pour les décès néonatals, le lieu de résidence sera généralement le même que celui où le décès est survenu."
      },
      "Id10057": {
        "label": "(Id10057) Où le décès est-il survenu ? (préciser le pays, la province, le district, le village)",
        "hint": "Doit être complété selon les instructions du bureau central.",
        "guidance": "Vous pouvez renseigner la ville/village au lieu du village si cela est plus pertinent. La question doit être adaptée spécifiquement au contexte local par l'équipe du projet."
      },
      "Id10059": {
      ...
      "Id10064": {
        ...
        "guidance": "Sélectionnez la réponse appropriée. Répondez « OUI » également si le défunt ne connaissait qu'un seul élément de lecture ou d'écriture. Notez que cette question vise à mesurer l'alphabétisation (c'est-à-dire non le handicap), si la personne décédée a appris à lire et/ou à écrire au cours de sa vie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10065": {
        ...
        "guidance": "Le défunt aurait pu avoir plusieurs activités. Choisissez celle qui était probablement vraie pendant la majeure partie de l’année précédant la maladie ou le décès. Sélectionnez la réponse appropriée. Si la réponse est « Principalement employé », passez à la question suivante. Sinon, passez à Id10476",
        "choices": {
      ...
      "Id10478": {
        "label": "(Id10478) [Sélectionnez l'un des mots suivants qui ont été mentionnés comme présents dans le récit.]",
        "guidance": "Cette question énumère certains des principaux risques associés à la mortalité dans le groupe d'âge des personnes décédées. Une fois que le répondant a fourni sa description des circonstances entourant le décès, relisez et notez tous les mots clés qu'il a pu mentionner et que le défunt possédait.",
        "constraintMessage": "Il n'est pas possible de sélectionner « Ne sait pas » ou « Aucune des réponses ci-dessus » avec d'autres options.",
        "choices": {
          "abdomen": "Abdomen",
      ...
      "Id10479": {
        "label": "(Id10479) [Sélectionnez l'un des mots suivants qui ont été mentionnés comme présents dans le récit.]",
      ...
      "Id10106": {
        "label": "(Id10106) Combien de minutes après la naissance le bébé a-t-il pleuré pour la première fois ?",
      ...
      "Id10376": {
        ...
        "guidance": "Cette question vise à confirmer le bien-être du fœtus pendant la période précédant l'accouchement. L’absence de mouvements suggère la possibilité que le bébé soit mort-né. Notez que cette question n’est pas obligatoire pour le logiciel d’analyse automatisée, mais elle sert de contrôle de cohérence interne.",
        "choices": {
          "before": "Avant",
          "after": "Après",
          "dk": "Je ne sais pas",
      ...
      "Id10112": {
        ...
        "guidance": "Cette question précise s'il y avait un problème notable concernant la respiration du bébé. La reconnaissance d'un problème respiratoire à la naissance est un indicateur important de conditions telles que l'asphyxie à la naissance.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10115": {
        "label": "(Id10115) Y a-t-il eu des contusions ou des signes de blessures sur le corps du bébé après la naissance ?",
        "guidance": "Une blessure à la naissance désigne une blessure survenue pendant la naissance, telle qu'une grosse ecchymose, un gonflement de la tête ou une fracture pouvant entraîner la mort de l'enfant. Après avoir demandé et enregistré la réponse à Id10115, appliquez les instructions suivantes, qui sont basées sur la réponse à Id10114. Si la réponse à Id10114 était « OUI » (c'est-à-dire enfant mort-né) ; puis passez à Id10116. Si la réponse à Id10114 était « NON/NSP/Réf » (c'est-à-dire né vivant) ; puis passez à Id10077",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10116": {
        ...
        "guidance": "Posez cette question uniquement si la réponse à Id10114 était « OUI », c'est-à-dire qu'il s'agissait d'une mortinatalité. Dans cette question, nous cherchons à évaluer l’intégrité de la peau d’un bébé mort-né. Parfois, le terme « macéré » est utilisé pour décrire la peau des bébés mort-nés. Lorsque macéré est utilisé pour décrire la peau, cela signifie que la peau, parfois décolorée, a pelé ou est en train de peler. Macéré signifie que le corps était pulpeux. Cela indique que le bébé est mort à l'intérieur de la mère ou depuis un certain temps. Si le terme macéré n'est pas utilisé, écoutez une description similaire de l'intégrité de la peau – desquamation, pulpeuse, décolorée, etc. Après Id10116, s'il s'agissait d'une mortinatalité, passez à Id10354.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10125": {
        ...
        "guidance": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10126": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si la personne décédée a déjà subi un test de dépistage du VIH et, si oui, si le test s'est déjà révélé positif.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10127": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si le défunt a déjà reçu un diagnostic de SIDA, la dernière maladie liée au VIH qui entraîne la mort. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10129": {
        "label": "(Id10129) A-t-il récemment subi un test négatif de dépistage du paludisme par un professionnel de la santé ?",
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
      ...
      "Id10482": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si la personne décédée a déjà reçu un diagnostic de COVID-19. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10484": {
        ...
        "guidance": "Si la personne décédée a subi un test de dépistage du COVID-19, demandez-lui doucement quel a été le résultat. Si une personne a été testée plus d'une fois au cours de sa dernière maladie, vérifiez si le DERNIER test était « positif », « négatif » ou « incertain ».",
        "choices": {
          "positive": "Positif",
          "negative": "Négatif",
          "unclear": "Peu clair",
      ...
      "Id10130": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si un diagnostic de dengue a été posé pendant la maladie qui a entraîné le décès. Il existe peut-être un terme local pour désigner la dengue. S'il y en a un, assurez-vous qu'il est mentionné dans le questionnaire traduit et utilisez ce terme pour poser des questions sur la dengue. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10131": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si un diagnostic de rougeole a été posé pendant la maladie qui a entraîné le décès. Il existe peut-être un terme local pour désigner la rougeole. S'il y en a un, assurez-vous qu'il est mentionné dans le questionnaire traduit et utilisez ce terme pour poser des questions sur la rougeole. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10133": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si la personne décédée a déjà reçu un diagnostic de maladie cardiaque par un médecin ou tout autre agent de santé. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10138": {
        "label": "(Id10138) Un professionnel de la santé a-t-il diagnostiqué une maladie pulmonaire obstructive chronique (MPOC) ?",
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si la personne décédée a reçu un diagnostic de BPCO par un médecin ou tout autre agent de santé. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie. Les personnes atteintes de BPCO ont de fréquentes périodes d'essoufflement ainsi que des accès de toux et d'expectorations, nécessitant souvent des soins médicaux pour un soulagement et un traitement.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10143": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si la personne décédée a reçu un diagnostic de maladie rénale par un médecin ou tout autre agent de santé récemment ou au cours de la dernière maladie. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie. Il peut exister un terme local pour désigner une maladie rénale. S'il y en a un, assurez-vous qu'il est mentionné dans le questionnaire traduit et utilisez le terme local pour approfondir.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10144": {
        ...
        "hint": "Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie.",
        "guidance": "Demandez si un médecin ou tout autre agent de santé a diagnostiqué une maladie du foie chez la personne décédée récemment ou au cours de la dernière maladie. Rappelez à l'enquêté que nous demandons le diagnostic évalué par un médecin, un agent de santé ou un autre professionnel de la santé lors de la dernière maladie. Il peut exister un terme local pour désigner une maladie du foie. S'il y en a un, assurez-vous qu'il est mentionné dans le questionnaire traduit et utilisez le terme local pour approfondir.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10086": {
        "label": "(Id10086) A-t-il été blessé par une morsure ou une piqûre venimeuse d'un animal ou d'un insecte ?",
        "hint": "Cela inclut les accidents et les cas où l’on ne sait pas s’il s’agit d’un accident ou s’il y a eu violence intentionnelle.",
        "guidance": "Enregistrez « OUI » si la blessure est due à une morsure de serpent ou à tout autre insecte venimeux. Cela inclut les accidents et les cas où l’on ne sait pas s’il s’agit d’un accident ou s’il y a eu violence intentionnelle. Si « OUI », passez à Id10088.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10087": {
        ...
        "guidance": "Enregistrez « OUI » en cas de morsure de chien ou de blessures causées par une attaque par un autre animal et notez le détail dans la réponse à la question suivante. Si « NON/NSP/Réf », passez à Id10089.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10088": {
        ...
        "guidance": "Sélectionnez un chien, un serpent, un insecte, un scorpion ou autre. Si vous ne le savez pas, sélectionnez « NSP ».",
        "choices": {
          "dog": "Chien",
          "snake": "serpent",
      ...
      "Id10091": {
        ...
        "guidance": "Utilisez le terme local pour désigner les armes à feu et enregistrez la réponse. Si la réponse à Id10091 est « OUI », les questions Id10092 à Id10097 doivent être ignorées. Si la réponse est « NON/NSP/Réf », passez au Id10092.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10092": {
        ...
        "guidance": "L’utilisation d’instruments tranchants tels qu’un couteau ou une épée doit être enregistrée ici. Si la réponse à Id10092 est « OUI », les questions Id10093 à Id10097 doivent être ignorées. Si la réponse est « NON/NSP/Réf », passez au Id10093.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10093": {
        ...
        "guidance": "Utilisez le terme local pour désigner l'étouffement du cou par la force, que ce soit avec la main, une corde ou un autre objet. Si la réponse à Id10093 est « OUI », les questions Id10094 à Id10097 doivent être ignorées. Si la réponse est « NON/NSP/Réf », passez au Id10096.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10095": {
        ...
        "guidance": "Les forces de la nature comprennent la foudre, les inondations, les tremblements de terre, les tsunamis, les feux de brousse, les éruptions volcaniques, etc. Si la réponse est « OUI », alors enregistrez la force de la nature dans la section narrative du questionnaire. Si la réponse est « OUI », passez à Id10100.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10097": {
        ...
        "guidance": "Si la blessure s'est produite dans des circonstances qui n'entrent pas dans les catégories ci-dessus (par exemple pendaison, explosion d'une mine terrestre, etc.), enregistrez la réponse en conséquence dans la section narrative.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10098": {
        ...
        "guidance": "Cette question permet de déterminer si la blessure était involontaire. Si « OUI », allez à Id10351.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10100": {
        ...
        "guidance": "Demandez si la blessure a été causée par un acte de violence soit directement par une autre personne, soit par une circonstance créée intentionnellement par une autre personne (par exemple, un acte de terrorisme).",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10121": {
        "label": "(Id10121) Mois",
        "constraintMessage": "Si la réponse a été supérieure à 11 mois, demandez au répondant de déclarer le délai en années. Veuillez également vérifier que la valeur saisie est inférieure à l'âge du défunt."
      },
      "Id10122": {
      ...
      "Id10120_1": {
        ...
        "constraintMessage": "Si la réponse a été supérieure à 30 jours, demandez au répondant de déclarer le temps passé dans une autre unité."
      },
      "Id10120": {
      ...
      "Id10148_b": {
        ...
        "constraintMessage": "Si la réponse a été supérieure à 30 jours, demandez au répondant de déclarer le délai en mois."
      },
      "Id10148_c": {
        "label": "(Id10148_c) [Entrez la durée de la fièvre en mois] :",
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "La réponse probable est inférieure à 60 mois. Si la réponse était supérieure à 60 mois, confirmez la réponse et inscrivez 60."
      },
      "Id10148": {
      ...
      "Id10149": {
        ...
        "guidance": "Dans le cas de fièvres de plus longue durée, il est important de savoir si la fièvre faisait également partie de la période terminale de la maladie précédant le décès.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10151": {
        ...
        "guidance": "Certaines infections produisent des schémas caractéristiques de fièvre – continue ou intermittente ; ou fièvre seulement la nuit. Si la question n'est pas directement comprise, mentionnez ces différents schémas et demandez si la fièvre a suivi l'un de ces schémas, puis enregistrez la réponse en conséquence.",
        "choices": {
          "continuous": "Continue",
      ...
      "Id10156": {
        ...
        "guidance": "La gravité de la toux fait référence à son importance parmi les symptômes présents chez le défunt. Il est souvent difficile de définir la gravité. Cependant, on pourrait évaluer la gravité de la toux en se demandant s'il y avait des accès de toux prolongés, ou si la toux était aggravée par la position allongée ou l'effort physique, et/ou si elle affectait le sommeil.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10158": {
        ...
        "guidance": "Dans certains cas, l’enfant peut émettre une coqueluche forte en inspirant avant une quinte de toux. Il s'agit d'un son caractéristique dont le répondant peut se souvenir, en particulier lorsque la toux est qualifiée de sévère.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10161_0": {
        "label": "(Id10161_0) Pendant combien de jours la difficulté respiratoire ou l’essoufflement a-t-il duré ?",
        "hint": "Si moins de 1 jour ou 24 heures, entrez 0 jour. Utilisez 1 semaine = 7 jours pour déterminer le nombre de jours. Pour je ne sais pas, entrez « 99 ». Pour refusé, entrez « 88 ».",
        "guidance": "La durée de la difficulté respiratoire ou de l’essoufflement peut aider à comprendre la gravité de la maladie et sa relation avec la cause du décès. Enregistrez le nombre de jours pendant lesquels l’enfant a eu des difficultés à respirer ou était essoufflé. Si cela a été observé seulement moins de 1 jour = 0 jour. La réponse à la durée des difficultés respiratoires peut aller de 0 à 30 jours. Utilisez 1 semaine = 7 jours pour déterminer le nombre de jours. Pour je ne sais pas, entrez « 99 ». Pour refusé, inscrivez « 88 ».",
        "constraintMessage": "Veuillez saisir une valeur inférieure à l'âge néonatal en jours au décès."
      },
      "id10161_unit": {
      ...
      "Id10162": {
        ...
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "Si la réponse a été supérieure à 11 mois, demandez au répondant de déclarer le délai en années."
      },
      "Id10163": {
      ...
      "Id10170": {
        "label": "(Id10170) Était-il incapable d'effectuer ses tâches quotidiennes à cause d'un essoufflement ?",
      ...
      "Id10167_a": {
        ...
        "hint": "Si moins de 1 jour ou 24 heures, entrez 0 jour. Utilisez 1 semaine = 7 jours pour déterminer le nombre de jours. Pour je ne sais pas, entrez « 99 ». Pour refusé, entrez « 88 ».",
        "guidance": "La durée d'une respiration rapide indique la gravité de la maladie mais constitue un signe difficile à reconnaître et à mémoriser. Si moins de 1 jour ou 24 heures, entrez « 0 ». Une durée de validité ne peut être supérieure à l'âge en jours du défunt. Utilisez 1 semaine = 7 jours pour déterminer le nombre de jours. Pour je ne sais pas, entrez « 99 ». Pour refusé, inscrivez « 88 ».",
        "constraintMessage": "Veuillez saisir une valeur inférieure à l'âge néonatal en jours au décès."
      },
      "Id10167_units": {
      ...
      "Id10173_a": {
        ...
        "guidance": "La respiration sifflante est un sifflement qui provient de la poitrine lors de l'expiration. L'intervieweur VA doit être formé pour démontrer une respiration sifflante au répondant. Lire le fichier audio si disponible.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10179": {
        ...
        "constraintMessage": "Si la réponse a été supérieure à 23 heures, demandez au répondant de déclarer le temps en jours."
      },
      "Id10179_1": {
      ...
      "Id10181": {
        ...
        "guidance": "Demandez à la personne interrogée quelle est sa compréhension de ce qu'est la diarrhée (avoir des selles molles ou liquides plus fréquentes que d'habitude) ; Si la réponse n'est pas claire ou est erronée, expliquez au répondant que la diarrhée est le passage fréquent de selles molles ou liquides, avec ou sans sang. Il peut y avoir des termes locaux pour le décrire, si c'est le cas, incluez-les dans la version locale traduite du questionnaire. Si « NON/NSP/Réf », passez à Id10186.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10183": {
        "label": "(Id10183) Combien de selles le bébé ou l'enfant a-t-il fait le jour où la diarrhée était la plus fréquente ?",
        "hint": "Pour je ne sais pas, entrez « 99 ». Pour refusé, entrez « 88 ».",
        "guidance": "Cette question enregistre la fréquence des diarrhées. Demandez au répondant le nombre maximum de fois où la personne décédée a eu la diarrhée au cours d'un jour quelconque de la période précédant immédiatement le décès et inscrivez ce nombre dans l'espace prévu. Une réponse valide est comprise entre 0 et 20. Si la réponse était supérieure à 20 selles, confirmez la réponse et inscrivez « 20 ». Pour je ne sais pas, entrez « 99 ». Pour refusé, inscrivez « 88 ».",
        "constraintMessage": "Veuillez saisir une valeur comprise entre 1 et 20, 88, 99. Si la réponse est supérieure à 20, confirmez la réponse et saisissez 20."
      },
      "Id10184_a": {
      ...
      "Id10184_units": {
        ...
        "guidance": "Cette question est posée pour relier spécifiquement l'épisode de diarrhée au décès. En cas de diarrhée aiguë (quelques jours seulement), notez le nombre de jours écoulés entre le début et le décès. En cas de diarrhée chronique (épisodes récurrents sur plusieurs semaines), noter la durée du dernier épisode. Sélectionnez la meilleure unité en fonction de la réponse – jours ou mois. Une réponse valide se situe entre 0 et 30 jours ou entre 1 et 60 mois. Pour moins d'un jour ou 24 heures, saisissez « 0 » jour. Utiliser 1 semaine = 7 jours. Une réponse probable est inférieure à 60 mois. Si la réponse donnée était supérieure à 60 mois, confirmez la réponse et inscrivez « 60 ». Si la personne interrogée ne se souvient pas exactement du nombre de jours, demandez-la et notez-la en fonction de ce qui est médicalement pertinent à saisir. Si la diarrhée a commencé :\n● moins de 3 jours avant le décès - l'enquêteur doit saisir 2 jours ; \n● commencé au moins 3 jours avant le décès – l'enquêteur doit saisir 4 jours.",
        "choices": {
          "days": "Jour",
          "months": "mois",
          "DK": "Ne sait pas",
      ...
      "Id10186": {
        "label": "(Id10186) À un moment donné au cours de la dernière maladie, y a-t-il eu du sang dans les selles ?",
        "guidance": "Cela peut être lié à la diarrhée, si elle est présente. Dans certaines infections, il peut y avoir du sang dans les selles, mais surtout chez les enfants et les adultes, mais rarement chez les nouveau-nés. Il est courant que cela soit observé par les soignants de nouveau-nés malades, le cas échéant.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10190_units": {
        ...
        "guidance": "Il est utile de connaître la période de temps pendant laquelle les épisodes de vomissements ont été présents, afin de comprendre la relation entre ce symptôme et une cause potentielle. Sélectionnez la meilleure unité en fonction de la réponse – jours ou mois. Une réponse valide se situe entre 0 et 30 jours ou entre 1 et 60 mois. Pour moins d'un jour ou 24 heures, saisissez « 0 » jour. Utiliser 1 semaine = 7 jours. Une réponse probable est inférieure à 60 mois. Si la réponse donnée était supérieure à 60 mois, confirmez la réponse et inscrivez « 60 ». Si la personne interrogée ne se souvient pas exactement du nombre de jours, demandez-la et notez-la en fonction de ce qui est médicalement pertinent à saisir. Si les vomissements durent :\n● pendant moins de 3 jours - l'enquêteur doit saisir 2 jours ;\n● pendant plus de 3 jours – l'enquêteur doit saisir 4 jours.",
        "choices": {
          "days": "Jour",
          "months": "mois",
          "DK": "Ne sait pas",
      ...
      "Id10192": {
        ...
        "guidance": "Dans certains cas, il peut y avoir un léger saignement dans l’estomac sur une période de plusieurs heures, avant de s’accumuler dans un volume suffisant pour déclencher des vomissements. Dans de tels cas, le contenu des vomissures n’apparaît pas aussi rouge vif, car le sang se mélange aux autres contenus de l’estomac et change de couleur pour devenir une substance semi-solide noirâtre. Il peut y avoir plus d’un épisode de vomissements de substance noirâtre – qui peuvent ressembler à du marc de café.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10196": {
        ...
        "constraintMessage": "Si la réponse était supérieure à 23 heures, demandez au répondant d'indiquer le temps passé dans une autre unité."
      },
      "Id10197_a": {
        "label": "(Id10197_a) [Entrez combien de temps il a eu des douleurs abdominales en jours] :",
        "hint": "Entrez 0 à 30 jours. 1 semaine = 7 jours.",
        "constraintMessage": "Si la réponse a dépassé 30 jours, demandez au répondant d'indiquer le délai en mois."
      },
      "Id10198": {
        "label": "(Id10198) [Entrez combien de temps il a eu des douleurs abdominales en mois] :",
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "La réponse probable est inférieure à 60 mois. Si la réponse est supérieure à 60, confirmez la réponse et entrez 60."
      },
      "Id10197": {
      ...
      "Id10200": {
        ...
        "guidance": "Certaines maladies (le plus souvent une insuffisance hépatique) provoquent une accumulation de liquide dans l'abdomen, ce qui entraîne une augmentation de la taille de l'abdomen, le rendant inhabituellement proéminent et saillant. De plus, en cas d'occlusion intestinale, il peut y avoir une accumulation de gaz et d'autres contenus intestinaux, mais cela est très rare par rapport à l'accumulation de liquide. Cette augmentation de la taille de l’abdomen est souvent observée et rappelée par les proches des défunts. Si « NON/NSP/Réf », passez à Id10204.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10201_unit": {
        "label": "(Id10201_unit) Pendant combien de temps avant sa mort avait-il un abdomen plus proéminent que d'habitude ?",
      ...
      "Id10201_a": {
        "label": "(Id10201_a) [Entrez combien de temps avant la mort il avait un abdomen plus saillant que d'habitude en jours] :",
        "hint": "Entrez 0 à 30 jours. Moins de 1 jour ou 24 heures = 0 jour ; 1 semaine = 7 jours.",
        "constraintMessage": "Si la réponse a dépassé 30 jours, demandez au répondant d'indiquer le délai en mois."
      },
      "Id10202": {
        "label": "(Id10202) [Entrez combien de temps avant la mort il avait un abdomen plus saillant que d'habitude en mois] :",
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "La réponse probable est inférieure à 60 mois. Si la réponse est supérieure à 60, confirmez la réponse et entrez 60."
      },
      "Id10201": {
      ...
      "Id10203": {
        ...
        "guidance": "L'apparition et la progression de ce signe suivent différents schémas dans différentes conditions ; en cas d'occlusion intestinale, elle serait relativement courte (quelques heures – 2/3 jours) ; mais elle est plus progressive dans d'autres affections plus courantes telles que l'insuffisance hépatique, les cancers et l'insuffisance cardiaque. Clarifiez et enregistrez la réponse.",
        "choices": {
          "rapidly": "Rapidement",
          "slowly": "lentement",
          "DK": "Ne sait pas",
      ...
      "Id10204": {
        ...
        "guidance": "La masse abdominale est un gonflement ou une hypertrophie localisée dans une zone de l’abdomen. Cela peut ne pas être perçu visiblement par les personnes interrogées et peut uniquement être rapporté par le défunt à ses proches, comme un sentiment de lourdeur ou d'inconfort. Souvent, il aurait pu y avoir une tentative de recours à des soins médicaux, qui pourraient être rappelés par les proches. Dans ce cas, il est possible qu'un diagnostic soit disponible dont le répondant pourrait se souvenir. S'il y a une réponse positive, sondez attentivement et n'oubliez pas de revenir sur cette question lors de l'enquête sur les dossiers médicaux dans la section 9, et enregistrez tous les détails pertinents sur l'accès aux soins de santé et les informations de diagnostic dans cette section. Si la réponse est « NON/NSP/Réf », passez à Id10207.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10208": {
        ...
        "guidance": "Une raideur de la nuque est généralement identifiée par l'incapacité de plier le cou vers l'avant pour toucher le menton avec la poitrine, ou par une difficulté à relever la tête de l'oreiller. C'est une caractéristique importante de la méningite (une infection cérébrale), en particulier chez les enfants. Ce signe peut ne pas être facilement observé ou rappelé par le répondant. Pour certains, une raideur de la nuque peut également être signalée comme une douleur au cou. Si nécessaire, clarifiez au répondant la description fournie ci-dessus et enregistrez la réponse. Si « NON/NSP/Réf », passez à Id10212.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10209_units": {
        "label": "(Id10209_units) Combien de temps avant sa mort avait-il une raideur ou une douleur à la nuque ?",
      ...
      "Id10209_a": {
        "label": "(Id10209_a) [Entrez combien de temps avant le décès, en jours, avait-il eu une raideur ou une douleur à la nuque] :",
        "hint": "Entrez 0 à 30 jours. Moins de 1 jour ou 24 heures = 0 jour ; 1 semaine = 7 jours.",
        "constraintMessage": "Si la réponse a dépassé 30 jours, demandez au répondant d'indiquer le délai en mois."
      },
      "Id10209_b": {
        "label": "(Id10209_b) [Entrez combien de temps avant le décès, en mois, avait-il eu une raideur ou une douleur à la nuque] :",
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "La réponse probable est inférieure à 60 mois. Si la réponse est supérieure à 60, confirmez la réponse et entrez 60."
      },
      "Id10209": {
      ...
      "Id10214": {
        ...
        "guidance": "L'inconscience signifie l'incapacité totale d'éveiller l'individu sans aucun mouvement autre que la respiration. L’individu ne répond même pas aux stimuli physiques, notamment à la douleur. La mort due à une maladie est généralement précédée d'une période de perte de conscience. Cette série de questions vise à identifier la perte de conscience comme un facteur spécifique important associé à la maladie menant à la mort, indiquant généralement une atteinte du cerveau. Il y a parfois une certaine hésitation ou incertitude sur cette question. Il existe peut-être un terme local pour décrire l'inconscience. Assurez-vous que le terme local est inclus dans la version traduite du questionnaire et utilisez le terme local pour approfondir. Si « NON/NSP/Réf », passez à Id10220.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10216_b": {
        ...
        "constraintMessage": "La réponse probable est inférieure à 99 jours. Si la réponse a été supérieure à 99 jours, confirmez la réponse et entrez 99."
      },
      "Id10216": {
        "label": "(Id10216) Combien d'heures avant la mort l'inconscience a-t-elle commencé ?"
      },
      "Id10217": {
        "label": "(Id10217) La perte de conscience a-t-elle commencé soudainement, rapidement (au moins en une seule journée) ?",
        "guidance": "La perte de conscience peut survenir soudainement en cas d'accident vasculaire cérébral (maladie cérébrovasculaire), ou survenir plus progressivement, de manière intermittente, sur une période de plusieurs heures/jours en cas de perte de conscience associée à des infections cérébrales ou à d'autres conditions. C'est généralement le cas des maladies infectieuses. Cette question vise à déterminer la perte de conscience soudaine en une journée maximum, ce qui se produit dans les maladies cérébrovasculaires, ce qui est rare chez les enfants. Clarifiez cet aspect avec le répondant, si nécessaire, et enregistrez la réponse.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10222": {
        ...
        "guidance": "La perte de conscience survient généralement après une convulsion généralisée, donc une réponse positive confirmera la survenue et facilitera ainsi le diagnostic.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10275": {
        "label": "(Id10275) Le bébé a-t-il eu des convulsions commençant au cours des premières 24 heures de sa vie ?",
        "guidance": "Les questions Id10275 et Id10276 visent à confirmer le moment et à identifier l'apparition des convulsions immédiatement après la naissance, au cours du premier jour de vie, qui sont susceptibles d'être associées à certains troubles congénitaux du cerveau ou à d'autres anomalies chimiques dans le sang. Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10276": {
        "label": "(Id10276) Le bébé a-t-il eu des convulsions commençant plus de 24 heures après la naissance ?",
        "guidance": "Les convulsions survenant après le premier jour de vie pourraient être associées au tétanos néonatal. Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10231": {
        ...
        "guidance": "La présence de pus dans l’ulcère du pied qui ne guérit pas est un signe diagnostique important. Le pus est un liquide épais de couleur verte ou jaune qui s’accumule continuellement à la surface de l’ulcère.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10238": {
        ...
        "guidance": "Chez une personne souffrant de malnutrition de longue date, la peau devient extrêmement sèche et a tendance à se détacher ou à se décoller par plaques. Il s’agit d’un signe facilement reconnaissable lorsqu’il est présent et constitue un signe diagnostique utile.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10239": {
        ...
        "guidance": "Nous posons cette question car cela pourrait indiquer que l'enfant a eu un saignement cutané, ce qui pourrait être dû à une infection qui a causé le décès.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10240": {
        ...
        "guidance": "Les infections cutanées peuvent parfois se manifester sous la forme de plaques de rougeur et de gonflement, sans présence de pus, ni de liquide. De telles infections peuvent être associées à de la fièvre et entraîner la mort.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10243": {
        ...
        "guidance": "Certaines maladies sont typiquement associées à une perte de poids rapide précédant le décès, qui pourrait être décrite comme « devenir très mince et faible », « développer des joues enfoncées », « les vêtements/la ceinture se détachent », etc. Une perte de poids de plus de 10 % en 3 mois environ est un signe important. Clarifiez ces aspects avec le répondant pour confirmer ou exclure la perte de poids, et enregistrez la réponse en conséquence. Indépendamment du fait que la réponse soit « OUI/NON/NSP/Réf », la question suivante doit être posée.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10245": {
        ...
        "guidance": "Des taches blanchâtres à l’intérieur de la bouche ou sur la langue sont révélatrices d’infections chez les personnes dont le système immunitaire est très faible. Le système immunitaire assure la défense de l’organisme pour lutter contre les infections. Ce signe peut être difficile pour le répondant, à moins d'en être informé par le patient ou par un prestataire de soins. Enregistrez la réponse telle que rapportée. Il peut y avoir un terme local pour décrire une éruption cutanée. Assurez-vous que le terme local est inclus dans la version traduite du questionnaire et utilisez le terme local pour approfondir.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10251": {
        ...
        "guidance": "Dans certains cas, il peut y avoir un gonflement d’un seul pied, auquel cas l’affection sous-jacente serait différente, il s’agirait plus probablement d’une affection locale de la jambe affectée plutôt que d’une maladie cardiaque ou rénale. Il est donc important de confirmer que le gonflement concernait les deux pieds.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10256": {
        ...
        "guidance": "Cette question vise à confirmer la présence de bosses au niveau de l'aisselle. Il aurait pu être difficile pour le répondant de les observer, à moins qu'ils ne soient signalés par le défunt ou signalés par un professionnel de la santé.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10257": {
        ...
        "guidance": "Cette question vise à confirmer la présence de bosses au niveau de l’aine, qui est la jonction entre le corps et le membre inférieur.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10260": {
        ...
        "guidance": "Il est important de confirmer si la paralysie affectait uniquement un membre en particulier, des parties du corps ou le corps tout entier. Marquez les parties spécifiques du corps qui ont été observées comme ayant été paralysées. Sélectionnez tout ce qui s'applique.",
        "constraintMessage": "Il n'est pas possible de sélectionner « Ne sait pas » ou « Refus de répondre » avec d'autres options ou de sélectionner « un seul côté paralysé » et « côté gauche et droit » ou « corps entier » ensemble. . Veuillez revenir en arrière et corriger la sélection.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10262_units": {
        "label": "(Id10262_units) Pendant combien de temps a-t-il eu des difficultés ou des douleurs à avaler ?",
      ...
      "Id10262_a": {
        "label": "(Id10262_a) [Entrez combien de temps avant le décès il a eu des difficultés ou des douleurs à avaler en jours] :",
        "hint": "Entrez 0 à 30 jours. Moins de 1 jour ou 24 heures = 0 jour ; 1 semaine = 7 jours.",
        "constraintMessage": "Si la réponse a dépassé 30 jours, demandez au répondant d'indiquer le délai en mois."
      },
      "Id10262_b": {
        "label": "(Id10262_b) [Entrez combien de temps avant le décès il a eu des difficultés ou des douleurs à avaler en mois] :",
        "hint": "Entrez 1 à 60 mois.",
        "constraintMessage": "La réponse probable est inférieure à 60 mois. Si la réponse est supérieure à 60, confirmez la réponse et entrez 60."
      },
      "Id10262": {
      ...
      "Id10262_c": {
        ...
        "guidance": "La question vise à savoir s'il est devenu impossible pour le défunt d'avaler un quelconque aliment solide ou liquide.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10267": {
        ...
        "guidance": "Chez les enfants plus âgés aux cheveux noirs, un changement de couleur des cheveux vers le rouge, le brun terne ou le jaune est révélateur d'une malnutrition modérée à avancée. Cela peut survenir en conjonction avec d’autres symptômes tels que la maigreur, l’émaciation et les infections.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10271": {
        "label": "(Id10271) Le bébé était-il capable de téter ou de prendre le biberon dans les 24 heures suivant la naissance ?",
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
        "guidance": "Une tétée ou une alimentation normale est un signe de bonne santé chez le nouveau-né. L'absence de tétée à la naissance est révélatrice de certaines conditions. Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10273": {
        ...
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
        "guidance": "Dans certaines infections comme le tétanos, le bébé perd la capacité de téter. La mère peut le reconnaître et est en mesure de signaler un tel arrêt si on lui demande soigneusement. Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10274_b": {
        "label": "(Id10274_b) [Entrez combien de temps après la naissance le bébé a arrêté de téter en jours] :",
        "hint": "Entrez 0 à 30 jours. Moins de 1 jour ou 24 heures = 0 jour ; 1 semaine = 7 jours.",
        "constraintMessage": "Si la réponse a dépassé 30 jours, demandez au répondant d'indiquer le délai en mois."
      },
      "Id10274_c": {
      ...
      "Id10277": {
        ...
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
        "guidance": "Le corps du nouveau-né peut devenir raide et courbé vers l’arrière en cas de tétanos néonatal. Les mères peuvent le reconnaître et le signaler lorsqu'on leur demande. Si le répondant a des difficultés à comprendre cette question, démontrez un corps raide et courbé vers l'arrière. Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10278": {
        ...
        "guidance": "La fontanelle est la zone molle située à l'avant de la tête d'un bébé/nourrisson qui peut enfler et se soulever en cas d'infection du cerveau. Le renflement signifie qu’il était enflé, poussé vers l’extérieur et tendu lorsque le nourrisson était en position assise. Les mères peuvent le reconnaître et le signaler correctement s'il était présent. Sondez attentivement afin d’obtenir une réponse précise.  Ne demandez que les défunts qui étaient",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10281": {
        ...
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
        "guidance": "L'inconscience signifie l'incapacité totale de réveiller le nouveau-né sans aucun mouvement autre que la respiration. L’enfant ne répond même pas aux stimuli physiques, notamment à la douleur. Les nouveau-nés malades peuvent dormir pendant de longues périodes, mais doivent vérifier s'ils ne peuvent pas être réveillés, même pour se nourrir. L'identification de l'inconscience repose en grande partie sur la suggestion d'une maladie ou d'un trouble du cerveau ou du système nerveux central. Une courte période d'inconscience précède généralement la mort. Dans le cas des nouveau-nés, il est difficile de définir l’inconscience comme un symptôme spécifique d’une atteinte du cerveau ou du système nerveux. Si \"NO/DK/Ref\" est sur Id10281, passez à Id10284",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10282": {
        "label": "(Id0282) Le bébé est-il devenu inconscient ou inconscient dans les 24 heures suivant la naissance ?",
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
      ...
      "Id10283": {
        "label": "(Id10283) Le bébé est-il devenu inconscient ou inconscient plus de 24 heures après la naissance ?",
        "hint": "Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
      ...
      "Id10284": {
        ...
        "guidance": "La froideur du corps indique que la température corporelle est inférieure à la normale, ce qui est associé à une maladie grave. Il s’agit toutefois d’un signe subjectif qui peut ne pas être facilement rappelé par le répondant. Il faut expliquer soigneusement ce qu'on entend par froid au toucher.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10286": {
        ...
        "guidance": "La léthargie signifie un manque de force ou d’activité, avec des yeux ternes. Ce signe peut ne pas être facilement rappelé par le répondant. Il est nécessaire d'expliquer soigneusement ce que l'on entend par léthargie ou de démontrer à quoi ressemblera un bébé léthargique. Si le bébé n’a jamais eu de période d’activité normale, cela devrait être « NON ».",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10287": {
        ...
        "guidance": "Une rougeur du cordon ombilical peut indiquer une infection grave. Il s’agit d’une source importante d’infection chez le nouveau-né, et ce signe peut être facilement reconnu et mémorisé par les répondants.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10288": {
        ...
        "guidance": "La présence d'ulcères ou de plaies cutanées, en particulier s'ils sont remplis d'un liquide jaunâtre (pus), indique le signe d'une infection cutanée grave, qui pourrait être liée à la cause du décès.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10486": {
        "label": "(Id10486) A-t-il subi une nouvelle perte, un changement ou une diminution de l'odorat ou du goût ?",
        "guidance": "Certains patients souffrant du COVID-19 auraient signalé à leurs soignants avoir remarqué un changement dans leur capacité à sentir ou à goûter les aliments. Vous devez préciser que vous posez des questions sur tout changement dans la capacité de sentir ou de goûter au cours de la maladie finale.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10313": {
        ...
        "guidance": "La plupart des décès maternels surviennent juste après l'accouchement. Cette question vise à confirmer que le décès est survenu après l'accouchement, et non pendant la grossesse ou le travail (période d'accouchement). Notez qu'un décès maternel est pertinent jusqu'à 1 an après l'accouchement. Si « OUI », passez à Id10314. Si « NON/NSP/Réf », passez à Id10334.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10308": {
        "label": "(Id10308) Est-elle décédée moins d'un an après l'accouchement, l'avortement ou la fausse couche ?",
        "guidance": "Cette question vise à identifier les décès survenus après 6 semaines mais dans l'année suivant l'accouchement ou l'interruption de grossesse. La limite d’un an est considérée comme la limite extérieure pour la définition des décès maternels tardifs. Si la réponse est « OUI », passez à Id10309. Si « NON/NSP/Réf », passez à Id10310.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10309": {
        ...
        "guidance": "Cette question vise à enregistrer la durée réelle de la grossesse en mois, au moment du décès. Écrivez le nombre de mois de grossesse révolus, par ex. 7,5 mois s'écrit 7 mois. Une réponse valide est comprise entre 0 et 11. Si la réponse est supérieure à 11 mois, confirmez la réponse et inscrivez « 11 ». Si le répondant ne se souvient pas exactement de la durée, invitez-le et enregistrez-le en fonction de ce qui est médicalement pertinent à saisir. Si la grossesse a duré :\n● depuis moins de 6 mois - l'enquêteur doit saisir 5 mois ;\n● ou plus de 6 mois – l'enquêteur doit saisir 7 mois.\nPour je ne sais pas, entrez « 99 ». Pour refusé, inscrivez « 88 ».",
        "constraintMessage": "Veuillez saisir une valeur comprise entre 0 et 11 mois.  Si la réponse est supérieure à 11, confirmez la réponse et saisissez 11."
      },
      "Id10317": {
        "label": "(Id10317) De combien de bébés était-elle enceinte ?",
        "guidance": "Certaines causes maternelles sont plus susceptibles de survenir en association avec une grossesse gémellaire. Précisez si elle était enceinte d'un singleton, de jumeaux, de triplés ou plus et enregistrez la réponse en conséquence.",
        "choices": {
          "singleton": "singleton",
          "twins": "jumeaux",
      ...
      "Id10321": {
        ...
        "guidance": "De nos jours, de nombreuses femmes enceintes font vérifier leur tension artérielle dans le cadre des soins prénatals, et la présence d'hypertension artérielle, si elle est détectée, est notifiée aux patientes. Demandez si la personne décédée a reçu un diagnostic d'hypertension artérielle lors d'une consultation de soins prénatals et enregistrez la réponse. Il est important de déterminer si la femme souffre d’hypertension artérielle, car si la pression est élevée, cela peut être lié à une maladie cardiaque ou à un accident vasculaire cérébral.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10322_a": {
        ...
        "guidance": "Des pertes vaginales nauséabondes indiquent une infection du canal génital et peuvent être remarquées pendant la grossesse. Des signes concomitants de douleur dans le bas-ventre et de fièvre peuvent être associés. Sondez attentivement et enregistrez les réponses.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10329_b": {
        "label": "(Id10329_b) A-t-elle eu des saignements excessifs pendant ou après un avortement ou une fausse couche ?",
      ...
      "Id10337": {
        ...
        "guidance": "Demandez au répondant quel est le lieu où la livraison a eu lieu et enregistrez la réponse en conséquence.",
        "choices": {
          "hospital": "Hôpital",
          "other_health_facility": "autre établissement de santé",
          "home": "à domicile",
      ...
      "Id10365": {
        "label": "(Id10365) À la naissance, le bébé était-il plus gros que d'habitude (pesant plus de 4,5 kg) ?",
        "hint": "Montrer des photos si disponibles. Cette question ne doit être posée que si l'enfant avait moins d'un an au moment de son décès.",
        "guidance": "Cette question est à poser uniquement si la réponse à Id10363 était « NON/NSP/Réf ». Les bébés nés plus gros que d'habitude sont associés à des problèmes causés à la mère lors de l'accouchement, mais parfois le nouveau-né présente également des risques accrus de blessures à la naissance, de malformations congénitales et de diabète.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10370": {
        "label": "(Id10370) Une partie du bébé était-elle physiquement anormale au moment de l'accouchement ? (par exemple : partie du corps trop grande ou trop petite, croissance supplémentaire sur le corps) ?",
        "guidance": "Une forme anormale d'un membre due à une déformation physique ou à toute anomalie physique externe peut entraîner un travail difficile et peut également être associée à d'autres malformations congénitales des organes internes pouvant être à l'origine du décès. Si la réponse est « NON », passez à Id10382. Si « OUI/NSP/Réf », passez aux questions suivantes.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10373": {
        ...
        "guidance": "Ceci est généralement associé soit à une mortinatalité, soit à une survie de quelques heures seulement. Cette affection est très rare, et se remarque par une absence d'os du sommet de la tête. Il s’agit d’une question sensible, il faut donc faire très attention à ne pas contrarier la personne interrogée en posant cette question.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10382": {
        ...
        "guidance": "La durée du travail a des implications importantes sur le bien-être du nouveau-né ainsi que sur celui de la mère. Renseignez-vous et enregistrez la durée totale du travail depuis l'apparition des douleurs jusqu'à la délivrance du placenta en heures. On s’attend à ce que cette réponse soit principalement une approximation plutôt qu’une mesure exacte. Si moins d'une heure, entrez « 0 » heures. Une réponse valide est comprise entre 0 et 99. Si la réponse a duré plus de 98 heures, confirmez la réponse et entrez « 98 ». Si la personne interrogée ne se souvient pas exactement de la durée, demandez-la et notez-la en fonction de ce qui est médicalement pertinent à saisir : Si le travail et l'accouchement ont duré :\n● pendant moins de 24 heures - l'enquêteur doit saisir 23 heures ;\n● pendant plus de 24 heures – l'enquêteur doit saisir 25 heures.\nPour je ne sais pas, entrez « 99 ». Pour refusé, inscrivez « 88 ». Si la durée indiquée est de 88 heures, inscrivez « 87 » afin que la réponse ne soit pas automatiquement codée comme refus de réponse.",
        "constraintMessage": "Saisissez un nombre entier d'heures compris entre 0 et 98. Utilisez 0 pendant moins d'une heure ; utiliser 23 ou 25 lorsque seule l'estimation à moins ou à plus de 24 heures est connue ; utilisez 88 pour refusé ; et utilisez 99 pour je ne sais pas. Si la durée réelle était de 88 heures, entrez 87."
      },
      "Id10383": {
        "label": "(Id10383) Le bébé est-il né 24 heures ou plus après la perte des eaux ?",
        "guidance": "Habituellement, la perte des eaux se produit peu de temps (jusqu'à quelques heures) avant le début de l'accouchement. Une fuite ou un bris d'eau pendant plus de 24 heures avant l'accouchement peut être associé à une infection et à d'autres causes de décès chez les nouveau-nés. Sondez attentivement pour obtenir une réponse précise à cette question.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10384": {
        ...
        "guidance": "L'alcool (l'eau dans l'utérus) peut avoir une mauvaise odeur en cas d'infection. Les mères seraient capables de s'en souvenir et de faire rapport. Sondez attentivement pour obtenir une vraie réponse.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10388": {
        ...
        "guidance": "Souvent, un terme local est utilisé pour désigner l'utilisation d'instruments destinés à faciliter l'accouchement. Renseignez-vous en utilisant ce terme et marquez la réponse en conséquence. Marquez la réponse en conséquence et si « OUI », passez à Id10391. Si « NON/NSP/Réf », passez à la question suivante.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10389": {
        ...
        "guidance": "Le terme « césarienne » fait référence à une opération abdominale qui consiste à ouvrir l’utérus et à extraire l’enfant de l’abdomen. Ce terme « césarienne » est communément connu des membres de la communauté, mais si nécessaire, les mots ou termes locaux désignant l'accouchement par opération abdominale pourraient être utilisés.",
        "constraintMessage": "Il n'est pas possible de répondre « Non » aux trois questions précédentes. Veuillez revenir en arrière et revoir les réponses.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10395": {
        ...
        "guidance": "La fièvre au moment de l'accouchement est une indication d'infections maternelles, qui pourraient avoir été transmises au bébé à ce moment-là. De telles infections pourraient être liées à la cause du décès du nouveau-né, c'est pourquoi l'identification de la fièvre chez la mère est un indicateur important.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10399": {
        "label": "(Id10399) Au cours des 3 derniers mois de la grossesse, du travail ou de l'accouchement, est-ce que vous/la mère du bébé avez souffert de convulsions ?",
      ...
      "Id10402": {
        "label": "(Id10402) Est-ce que vous/la mère du bébé avez eu des saignements vaginaux au cours des 3 derniers mois de la grossesse mais avant le début du travail ?",
        "guidance": "Un saignement du canal génital avant le début du travail est un signe important et est souvent associé à un trouble du placenta (utiliser un terme local). Des saignements excessifs mettent en danger la vie de la mère et du nouveau-né. Ceci est généralement facilement rappelé et rapporté par la mère.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10403": {
        "label": "(Id10403) Les fesses, les pieds, le bras ou la main du bébé sont-ils sortis du vagin avant sa tête ?",
        "guidance": "La première partie du bébé à naître est généralement la tête. La présentation de toute autre partie du corps en premier (par exemple les fesses, les pieds, le bras ou la main) est associée à plusieurs causes de décès néonatal, notamment les blessures à la naissance, les problèmes respiratoires graves et les infections pulmonaires. Les mères connaissent généralement la partie du corps qui a été accouchée en premier et peuvent donner la vraie réponse à cette question si on la leur pose soigneusement.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10404": {
        "label": "(Id10404) Le cordon ombilical a-t-il été enroulé plus d'une fois autour du cou de l'enfant à la naissance ?",
        "guidance": "Les mères sauraient si le cordon était autour du cou, mais ne se souviendraient peut-être pas du nombre de fois. Il est important de vérifier si le cordon a été enroulé plus d'une fois, car le risque de décès du bébé augmente s'il a été enroulé plus d'une fois.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10405": {
        ...
        "guidance": "Il s’agit d’une pathologie relativement rare, mais associée à des issues néonatales indésirables. La mère peut ne pas avoir pleinement connaissance de son apparition.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10406": {
        ...
        "guidance": "La couleur bleuâtre du bébé à la naissance suggère un problème affectant la respiration du bébé. Les mères peuvent être en mesure de signaler que le bébé était bleu ou est devenu foncé si elles sont soigneusement sondées.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10413": {
        ...
        "guidance": "Le terme « fumée » est utilisé dans cette question pour désigner spécifiquement les types de tabac fumés. Le tabagisme est lié, entre autres, au cancer du poumon, au cancer de la bouche et à l'asthme chronique. Cette question ne vise pas à saisir l’usage ou la consommation de tabac à chiquer. La série s'interroge sur le tabagisme à n'importe quelle période de la vie (c'est-à-dire pas seulement sur l'état actuel avant la mort). Si la réponse est « NON/NSP/Réf », passez à Id10414.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10413_a": {
        ...
        "guidance": "Inscrivez la durée pendant laquelle le défunt a fumé du tabac en nombre de mois ou d'années. Si la personne décédée a fumé pendant moins d'un mois, inscrivez 1 mois comme durée.",
        "choices": {
          "months": "Mois",
          "years": "Années",
          "dk": "Je ne sais pas",
      ...
      "Id10414": {
        ...
        "hint": "Pour clarifier, la série s'interroge sur la consommation de tabac à n'importe quelle période de la vie (c'est-à-dire pas seulement sur l'état actuel avant le décès).",
        "guidance": "La question vise à saisir la consommation de produits du tabac sans fumée sous forme de mastication et/ou de reniflage. Si la réponse est « NON/NSP/Réf », passez à Id10418.",
        "constraintMessage": "Il n'est pas possible de sélectionner des cigarettes ou une pipe et de répondre « non » à « A-t-il fumé du tabac ? ». Veuillez revenir en arrière et corriger les sélections.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10414_a": {
        ...
        "guidance": "Inscrivez la durée pendant laquelle la personne décédée a mâché et/ou reniflé du tabac, en nombre de mois ou d'années. Si la personne décédée a mâché et/ou reniflé du tabac pendant moins d'un mois, inscrivez 1 mois comme durée.",
        "constraintMessage": "Il n'est pas possible de sélectionner des cigarettes ou une pipe et de répondre « non » à « A-t-il fumé du tabac ? ». Veuillez revenir en arrière et corriger les sélections.",
        "choices": {
          "months": "Mois",
          "years": "Années",
      ...
      "Id10414_b": {
        ...
        "guidance": "La question vise à savoir s’il y a eu une période dans la vie du défunt où il a mâché et/ou sniffé du tabac quotidiennement (c’est-à-dire au moins 1 fois par jour) – même si cette période n’a pas été continue ou si le défunt n’a pas mâché et/ou sniffé du tabac pendant la période ayant conduit au décès.",
        "constraintMessage": "Il n'est pas possible de sélectionner des cigarettes ou une pipe et de répondre « non » à « A-t-il fumé du tabac ? ». Veuillez revenir en arrière et corriger les sélections.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
      ...
      "Id10419": {
        ...
        "guidance": "Les sels de réhydratation orale se présentent sous forme de sachet de poudre qui doit être dissous dans l'eau et administré aux personnes souffrant de diarrhée, en particulier aux enfants. Il s’agit d’un remède efficace et connu pour prévenir la mort. Cette question concerne uniquement les sachets fournis par les professionnels de santé, et non les solutions faites maison. Cette question vise à évaluer la disponibilité et l'accès aux services de santé.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10420": {
        ...
        "guidance": "Un goutte-à-goutte est généralement administré dans un centre de santé par un agent de santé qualifié. L'administration d'un goutte-à-goutte est évocatrice d'affections graves telles qu'une déshydratation.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10421": {
        ...
        "guidance": "Une transfusion sanguine est également une indication de la gravité de la maladie et peut être évocatrice de causes de décès associées à une perte de sang aiguë.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10426": {
        ...
        "guidance": "Le moment de l’opération permettra de déterminer tout lien entre le traitement et la cause du décès.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10436": {
        ...
        "guidance": "Enregistrez ici les détails de toute information communiquée verbalement sur la cause probable du décès."
      },
      "Id10446": {
        "label": "(Id10446) La mère (biologique) du défunt a-t-elle déjà été informée qu'elle était atteinte du VIH/SIDA par un agent de santé ?",
        "guidance": "Il s’agit peut-être d’une question sensible, mais il s’agit d’informations très importantes qui peuvent aider à déterminer la cause du décès.",
        "choices": {
          "yes": "Oui",
          "no": "Non",
          "dk": "Ne sait pas",
      ...
      "Id10072": {
        ...
        "hint": "Entrez un « - » si cette information n'est pas disponible.",
        "guidance": "Enregistrez tous les détails du lieu d’enregistrement. Cela peut inclure le nom du village/ville/municipalité où le décès a été enregistré. Entrez « - », si cette information n'est pas disponible. Le site du projet peut ajouter une liste déroulante d'options d'emplacement."
      },
      "Id10073": {
        ...
        "guidance": "Enregistrez le numéro d’identification national. Pour les nouveau-nés qui n’ont pas de numéro d’identification, utilisez la pièce d’identité de la mère. Si la pièce d’identité de la mère n’est pas disponible, utilisez la pièce d’identité du père. Si ces informations sont inconnues ou non disponibles, entrez « - ». Notez dont l'ID a été saisi dans l'espace après que l'ID a été enregistré."
      },
      "noteccd": {
        "label": "Certificat de décès avec cause du décès : \"Il s'agit du certificat médical indiquant la cause du décès (montrer l'image du certificat médical local indiquant la cause du décès, si disponible).\""
      },
      "Id10462": {
      ...
      "Id10466": {
        ...
        "guidance": "Copiez la cause de la deuxième ligne de l'acte de décès s'il y en a une ainsi que sa durée."
      },
      "Id10467": {
      ...
      "Id10468": {
        ...
        "hint": "Si ce détail n'est pas présent, inscrivez \"-\" (non disponible).",
        "guidance": "Copiez la cause de la troisième ligne de l'acte de décès s'il y en a une ainsi que sa durée."
      },
      "Id10469": {
      ...
      "Id10470": {
        ...
        "hint": "Si ce détail n'est pas présent, inscrivez \"-\" (non disponible).",
        "guidance": "Copiez la cause de la quatrième ligne de l'acte de décès s'il y en a une ainsi que sa durée."
      },
      "Id10471": {
      ...
      "Id10472": {
        "label": "(Id10472) [Enregistrer la ou les causes contributives du décès à partir du certificat (partie 2)]",
        "hint": "Si ce détail n'est pas présent, inscrivez \"-\" (non disponible).",
        "guidance": "Énumérez toutes les causes contributives enregistrées dans la partie II du certificat de décès."
      },
      "Id10473": {
